...
const navItems = [
    { path: '/', icon: LayoutDashboard, label: 'Dashboard', roles: ['Admin', 'Manager', 'Dispatcher', 'Safety Officer', 'Financial Analyst'] },
    { path: '/vehicles', icon: Truck, label: 'Vehicles', roles: ['Admin', 'Manager', 'Dispatcher'] },
    { path: '/trips', icon: Route, label: 'Trips', roles: ['Admin', 'Manager', 'Dispatcher'] },
    { path: '/maintenance', icon: Wrench, label: 'Maintenance', roles: ['Admin', 'Manager'] },
    { path: '/expenses', icon: Receipt, label: 'Expenses', roles: ['Admin', 'Manager', 'Financial Analyst'] },
    { path: '/drivers', icon: Users, label: 'Drivers', roles: ['Admin', 'Manager', 'Dispatcher', 'Safety Officer'] },
    { path: '/analytics', icon: BarChart3, label: 'Analytics', roles: ['Admin', 'Manager', 'Financial Analyst'] },
];
